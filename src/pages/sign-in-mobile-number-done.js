  ...
  return (
    <div className={styles.signInMobileNumberDone}>
      ...
      <div className={styles.continueWithFacebookLeftParent}>
        ...
        <Button className={styles.button}  onClick={logiFunction} style={{backgroundColor:'#007DFA', color: '#FFFFFF'}}>
          <Typography className={styles.continue} >Continue</Typography>
        </Button>
      </div>
      <div className={styles.frameGroup}>
        ...
        <div className={styles.group}>
          ...
          />
          <div className={styles.mobileNumber}>945 6784567</div>
        </div>
...
export default SignInMobileNumberDone;
