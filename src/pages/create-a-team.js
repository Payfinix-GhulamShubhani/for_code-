...
const CreateATeam = () => {
  ...
  return (
    <div className={styles.createATeam}>
      <div className={styles.titleImageParent}>
        ...
        <div className={styles.top10}>
          ...
          <div className={styles.six}>
            <img className={styles.icon} alt="" src="/61.svg" />
        ...
        <img className={styles.groupChild} alt="" src="/rectangle-893.svg" />
        ...
        <img className={styles.groupInner} alt="" src="/rectangle-894.svg" />
        <img className={styles.rectangleIcon} alt="" src="/rectangle-895.svg" />
        ...
        <div className={styles.navigation}>
          ...
          <div className={styles.search2}>
            <div className={styles.rectangleGroup}>
              ...
              <img
                className={styles.searchGroupIcon1}
                alt=""
                src="/search-group1.svg"
              />
              <div className={styles.search3}>Search</div>
            </div>
          </div>
            ...
            <div className={styles.menuItems}>
              ...
              <div className={styles.iconnavigationarrowBackIosParent}>
                <img
                  ...
                  alt=""
                  src="/iconnavigationarrow-back-ios-24px4.svg"
                />
                <div className={styles.explore}>New York</div>
              </div>
      ...
      <div className={styles.createATeamChild} />
      <div className={styles.signInParent}>
        <div className={styles.signIn}>
          <div className={styles.groupParent}>
            <div className={styles.groupContainer}>
              <div className={styles.groupDiv}>
                ...
                <div className={styles.forgetPasswordControl}>
              ...
              <div className={styles.inviteViaEmail}>Invite via Email</div>
            </div>
            <div className={styles.sharingLinkParent}>
              <div className={styles.sharingLink}>Sharing Link</div>
              <div className={styles.addressCopy}>
                <div className={styles.addressCopyChild} />
                <div className={styles.cardBg} />
                <div className={styles.hyggfjf}>HYGGFJF</div>
                <div className={styles.button1}>
                  <div className={styles.buttonBaseiconRight1}>
                    <img className={styles.icons1} alt="" src="/icons.svg" />
                    <div className={styles.buttonLabel}>Copy</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <img
              className={styles.twitterSocialnetwork200071Icon}
              alt=""
              src="/twitter-socialnetwork-20007-1@2x.png"
            />
            <div className={styles.groupChild5} />
            <img
              className={styles.linkedinSocialnetwork174411Icon}
              alt=""
              src="/linkedin-socialnetwork-17441-1@2x.png"
            />
          </div>
          <div className={styles.addressCopyParent}>
            <div className={styles.addressCopy1}>
              <div className={styles.addressCopyChild} />
              <div className={styles.cardBg} />
              <div className={styles.hyggfjf}>Name</div>
            </div>
          ...
          <img
            ...
            alt=""
            src="/group-16865520311.svg"
          />
          <img
            className={styles.image1689Icon}
            alt=""
