...
import styles from "./my-profile-groups-edit.module.css";
import { useState } from "react";
const MyProfileGroupsEdit = () => {
  const [open, setopen] = useState(false)
  const handleClick = ()=>{
    setopen(!open)
  }
  return (
    <div className={styles.myProfileGroupsEdit}>
      ...
      <div className={styles.myProfileGroupsEditChild} />
      ...
      <div className={styles.findCousreParent}>
        ...
        <div className={styles.findCousre1}>Edit</div>
        <div className={styles.findCousre2}>Edit</div>
        <div className={styles.rectangleContainer}>
          ...
          <div className={styles.groupParent}>
            <img
              ...
              alt=""
              src="/group-16865520575@2x.png"
            />
            <div className={styles.findCousre3}>Group 2</div>
            <img
              className={styles.groupChild1}
              alt=""
              src="/group-1686552071@2x.png"
            />
          </div>
        </div>
        <div className={styles.groupDiv}>
          ...
          <div className={styles.groupParent}>
            <img
              className={styles.groupIcon}
              alt=""
              src="/group-16865520576@2x.png"
            />
            <div className={styles.findCousre3}>Group 3</div>
            <img
              className={styles.groupChild1}
              alt=""
              src="/group-1686552071@2x.png"
      ...
      <div className={styles.findCousreGroup}>
        ...
        <div className={styles.groupParent3}>
          <img
            className={styles.groupIcon}
            alt=""
            src="/group-16865520578@2x.png"
          />
          <div className={styles.findCousre3}>Lorem ipsum</div>
...
export default MyProfileGroupsEdit;
